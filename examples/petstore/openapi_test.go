...
func TestPetStoreOpenAPI(t *testing.T) {
	...
	petSchema, exists := doc.Components.Schemas.Get("github.com/utrack/pontoon/examples/petstore.Pet")
	require.True(t, exists)
	...
	categorySchema, exists := doc.Components.Schemas.Get("github.com/utrack/pontoon/examples/petstore.Category")
	require.True(t, exists)
	...
	// Verify Tag schema
	tagSchema, exists := doc.Components.Schemas.Get("github.com/utrack/pontoon/examples/petstore.Tag")
	require.True(t, exists)
